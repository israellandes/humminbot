...
from hummingbot.core.event.events import RemoteEvent, RemoteCmdEvent
...
class RemoteCommandsDelegateBase:
    ...
    def on_remote_cmd(self, event_tag: int, executor: RemoteCommandExecutor, event: Union[RemoteCmdEvent]):
        """
