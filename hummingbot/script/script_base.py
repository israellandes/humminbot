...
from hummingbot.core.event.events import BuyOrderCompletedEvent, SellOrderCompletedEvent, RemoteCmdEvent
...
class ScriptBase:
    ...
    def locate_central_price_volatility(
        self, interval: int, length: int, locate_function: Callable
    ) -> Optional[Decimal]:
        """
